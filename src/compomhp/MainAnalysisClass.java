...
//		  Options.v().set_soot_classpath(classPath+"/bfiles/"+arg.bench);
		}
...
//		HA= false;
	...
	public Arg(Arg arg) {
		...
		materialized = arg.materialized;
		combined = arg.combined;
		fs = arg.fs;
		poa = arg.poa;
		mhp = arg.mhp;
		useCHA = arg.useCHA;
		genParallel = arg.genParallel;;
		interleaved = arg.interleaved;;
//		HA= false;
		callLog = arg.callLog;;
		writeResults = arg.writeResults;;
		iterative = arg.iterative;;
		bot=arg.bot;;
		esc=arg.esc;;
		pmhp2 = arg.pmhp2;;
		usePrevMHP=arg.usePrevMHP;;
		usePrevP2=arg.usePrevP2;;
		doopcode = arg.doopcode;;
